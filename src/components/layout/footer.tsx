        ...
        <footer className="bg-white sm:p-6 dark:bg-gray-900">
            <div className="">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Movie<span className='text-red-500'>Star</span></span>
                        </Link>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" className="hover:underline">Mahesadev</a>. All Rights Reserved.
                    </span>
